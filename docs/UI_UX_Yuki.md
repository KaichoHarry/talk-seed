...
| 3 | 会話サポート画面 | 話題表示、音声読み上げ、音声設定、会話記録 |
| 4 | 会話まとめ画面 | AIによる要約、盛り上がった話題の表示 |
| 5 | 履歴画面 | 過去の会話ログを確認 |

※記録中専用画面は作成しない。会話サポート画面内で記録中の表示に切り替える。  
※音声設定は独立した画面ではなく、会話サポート画面から開く設定パネルとして扱う。
...
AIが会話の話題を表示し、音声で読み上げる。さらに、同じ画面内で音声設定と会話記録を操作できるようにする。
...
|---|---|---|
| 標準 | 一般的で聞き取りやすい | 通常利用 |
| 明るい | 元気で楽しい印象 | 友人・イベント・ライブ待ち |
| 落ち着いた | ゆっくりで穏やかな印象 | 飲食店・家族との会話 |
| はっきり | 明瞭で聞き取りやすい | 周囲が少し騒がしい場所 |
